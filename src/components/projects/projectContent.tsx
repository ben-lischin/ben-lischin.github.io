  ...
  return (
    <div className="projectContent">
      ...
      <div className="projectLinks">
        <a href="https://github.com/benmash/splinterdb" target="_blank">
          GitHub
        </a>
        <a
          href="https://docs.google.com/document/d/1xFWvl3AejVlAhovsn5ozmQT9LmScdhqvDo164XTmi38/edit?usp=sharing"
          target="_blank"
        >
          Report
        </a>
      ...
      <div className="projectDescription">
        <p>
          <a
            href="https://www.usenix.org/system/files/atc20-conway.pdf"
            target="_blank"
          >
            SplinterDB
          </a>{" "}
          is VMware's production-grade key-value store built on the novel
          Size-Tiered B<sup>&epsilon;</sup>-Tree indexing structure.
        </p>
        <p>
          This project is an exploration of SplinterDB's internal system,
          identifying opportunities to optimize range queries with{" "}
          <a href="https://arxiv.org/pdf/2408.05625" target="_blank">
            Memento filters
          </a>
          . An initial implementation with results and benchmarking was
          completed for POC. See the report above for a comprehensive analysis.
        </p>
      </div>
...
const Sketching = () => {
  return (
    <div className="projectContent">
      ...
      <div className="projectLinks">
        <a href="https://github.com/ben-lischin/heavy_hitters" target="_blank">
          GitHub
        </a>
      ...
      <div className="projectDescription">
        <p>
          <u>def</u>: Given an input stream S of size N, a &phi;-heavy hitter is
          an item that occurs at least &phi;N times in S.
        </p>
        <p>
          Implemented Misra-Gries, Count Sketch, and Count-Min Sketch for
          solving the &phi;-heavy hitters problem in a single-pass streaming
          context. These sketching algorithms use probabilistic data structures
          to approximate the frequency of items in the stream, offering
          significant memory reduction compared to traditional alternatives.
        </p>
        <p>
          Generated universal, pairwise independent hash families used in the
          Count and Count-Min Sketches to guarantee bounded error and variance
          with high probability. Exploited Mersenne prime properties and
          power-of-two counters to accelerate modular reduction in hashing by
          &gt;7x.
        </p>
        {/* <p>
        ...
        <p>
          Evaluated the precision, recall, update time, and space usage of the
          sketching algorithms against a ground truth hash table, ingesting a
          Zipfian disitribution stream to model naturally occurring skewed
          frequencies.
        </p>
      </div>
      <div className="projectSkills">
...
const VEB = () => {
  return (
    <div className="projectContent">
      ...
      <div className="projectLinks">
        <a
          href="https://github.com/ben-lischin/VanEmdeBoasTree"
          target="_blank"
        >
          GitHub
        </a>
        <a
          href="https://docs.google.com/document/d/1vSFSN-2-h5nnO41R7dqx1Rf1waQMeApxQTPV82dTbNo/edit?usp=sharing"
          target="_blank"
        >
          Report
        </a>
      ...
      <div className="projectDescription">
        <p>
          A Van Emde Boas compact tree supports O(loglogU) operations on integer
          elements in fixed universe u: insert, delete, query, successor search.
        </p>
        <p>
          To improve runtime, I introduced a base class utilizing bitset
          representation for O(1) operations with minimal space, avoiding costly
          low-level recursion. To achieve optimal amortized runtime for inserts
          and deletes, min is lazily propagated into recursive levels. Lazy
          loading was also used to reduce unnecessary memory overhead for
          allocating empty nested VEB structures, especially for small set
          representation.
        </p>
        <p>
          This implementation outperformed the std::set balanced binary search
          tree, especially with larger set representation. See the report above
          for a more in-depth performance analysis.
        </p>
      </div>
      <div className="projectSkills">
        <div className="projectSkill">C++</div>
...
const UTTT = () => {
  return (
    <div className="projectContent">
      ...
      <div className="projectLinks">
        <a
          href="https://github.com/ben-lischin/ultimate_tictactoe"
          target="_blank"
        >
          GitHub
        </a>
        <a
          href="https://drive.google.com/file/d/18W7IUlr39F0vKJJ4Cq-WUaHWkKBkCHAi/view?usp=sharing"
          target="_blank"
        >
          Report
        </a>
      ...
      <div className="projectDescription">
        <p>
          This project is a comparative analysis of 3 AI Agents in Ultimate
          Tic-Tac-Toe: Minimax, Monte Carlo Tree Search, Deep Q-Learning.
        </p>
        <p>
          We modeled the game using compact bit representation for subboards,
          enabling efficient forward-simulation of game states in search-based
          agents where deepcopy becomes a performance bottleneck. All agents
          implement a standardized predict(state: UTTT) API, allowing the game
          engine to simulate matchups between any two strategies. In testing, we
          also introduce a new random-move agent as a control baseline.
        </p>
        <p>
          Our results highlight the strength of traditional adversarial search
          with domain-specific heuristics in a deterministic, fully observable
          environment, while revealing flaws with both stochastic planning and
          learning-based approaches in this situation.
        </p>
      </div>
      <div className="projectSkills">
...
const Shogi = () => {
  return (
    <div className="projectContent">
      ...
      <div className="projectLinks">
        <a
          href="https://github.com/ben-lischin/covey.town-shogi"
          target="_blank"
        >
          GitHub
        </a>
      ...
      <div className="projectDescription">
        <p>
          This extension of the original Covey.Town codebase enables users to
          play and spectate real-time single or multiplayer games of Shogi. We
          provide various informational and assistive features to help you
          figure out the game. When a match starts, each player is given a
          10-minute move clock, forfeiting the game at 0. While waiting for
          another user to join, players have the option to begin a game against
          our Shogi engine. This engine is implemented using the Negamax
          algorithm, with adjustable search depth for scalable difficulty
          settings.
        </p>
        <p>
          Integrated Firebase to support user authentication and record
          persistence across sessions, feeding the town leaderboard with all
          active player stats.
        </p>
      </div>
      <div className="projectSkills">
