        ...
        <section id="experience">
            ...
            <div className="timeline">
                              ...
                              <div className="desc">
                                ...
                                {expand3 && 
                                    <div>
                                        ...
                                        <p>Created a dashboard providing visibility into Klaviyo's email sending metrics – designing a data collection system as well as building a centralized dashboard to present the information.</p>
               ...
               <div>
                  ...
                  <div className="timeline-date timeline-date-right">Dec 2023 - Apr 2024</div>
               </div>
                <div className="timeline-block timeline-block-right">
                   <div className="marker"></div>
                   <div className="timeline-content">
