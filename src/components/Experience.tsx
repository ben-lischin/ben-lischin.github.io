      ...
      <div className="timeline">
        <div>
          <div className="timeline-block timeline-block-right">
            <div className="timeline-content">
              <h3 onClick={() => openLink("https://www.klaviyo.com/")}>
                Klaviyo
              </h3>
            </div>
          </div>
          <div className="timeline-block timeline-block-right">
            ...
            <div className="timeline-content">
              ...
              >
                ...
                />
                {!expand3 && <span> ...</span>}
                <div className={`desc-wrapper ${expand3 ? "open" : ""}`}>
                  <div>
                    <ul>
          ...
          <div className="timeline-block timeline-block-right">
            ...
            <div className="timeline-content">
              ...
              >
                ...
                />
                {!expand2 && <span> ...</span>}
                <div className={`desc-wrapper ${expand2 ? "open" : ""}`}>
                  <div>
                    <ul>
                      <li>
        ...
        <div className="timeline-block timeline-block-right">
          <div className="timeline-content">
            ...
            <h3 onClick={() => openLink("https://www.validity.com/")}>
              Validity
            </h3>
          </div>
        </div>
        <div className="timeline-block timeline-block-right">
          ...
          <div className="timeline-content">
            ...
            >
              ...
              />
              {!expand1 && <span> ...</span>}
              <div className={`desc-wrapper ${expand1 ? "open" : ""}`}>
                <div>
                  <ul>
                    <li>
