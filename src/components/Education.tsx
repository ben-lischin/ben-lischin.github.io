    ...
    <section id="education">
      ...
      <div className="educationContainer">
        <div className="education">
          <div
            className="icon gt"
            onClick={() => openLink("https://www.gatech.edu/")}
          >
          ...
          <div className="education-description">
            ...
            <div className="coursework">
              <p>Coursework:</p>
              <div className="courses">Computer Networks, Network Science, Operating Systems, Advanced OS</div>
            </div>
          </div>
        </div>
        <hr />
        <div className="education">
          <div
            className="icon neu"
            onClick={() => openLink("https://www.northeastern.edu/")}
          >
          ...
          <div className="education-description">
            ...
            <div className="coursework">
              ...
              <div className="courses">
                <span className="course-type">[CS]:</span> Algorithms & Data
                Structures, Algorithms for Scalable Computing, Software
                Engineering, Object-Oriented Design, Databases, Computer
                Systems, Artificial Intelligence, iOS Development, Logic &
                Computation, Theory of Comutation, Discrete Structures,
                Cybersecurity, Data Science
              </div>
              <div className="courses">
                <span className="course-type">[Math]:</span> Matrix Methods for
                Machine Learning, Linear Algebra, Multivariable Calculus,
                Statistics & Stochastic Processes, Probability & Statistics,
                Differential Equations, Group Theory, Number Theory, Geometry
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="education">
          <div
            className="icon rhs"
            onClick={() => openLink("https://www.regis.org/")}
          >
